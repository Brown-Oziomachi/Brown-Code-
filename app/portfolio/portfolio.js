                    ...
                    <div className="lg:col-span-4 flex flex-col justify-between bg-[#0b132b]/40 border border-slate-800/80 p-6 rounded relative backdrop-blur-sm">
                        <div className="space-y-6">
                            ...
                            <div className="space-y-1.5 text-center sm:text-left">
                                <h2 className="text-xl font-black text-white uppercase tracking-tight">Brown AD</h2>
                            ...
                            <div className="space-y-2 text-xs border-t border-slate-800/60 pt-4">
                                <div className="flex justify-between"><span className="text-slate-500">NET_LOC:</span> <span className="text-slate-300 font-bold">NIGERIA [GMT +1]</span></div>
                                <div className="flex justify-between"><span className="text-slate-500">CORE_RUNTIME:</span> <span className="text-slate-300 font-bold">NODEJS / ES6+</span></div>
                                <div className="flex justify-between items-center">
                                    <span className="text-slate-500">SOCKET_STATUS:</span>
                                    <span className="text-[10px] text-emerald-400 font-bold bg-emerald-950/20 border border-emerald-900/40 px-2 py-0.5 rounded">
                                        LISTENING_FOR_HIRE
                                    </span>
                                </div>
                            </div>
