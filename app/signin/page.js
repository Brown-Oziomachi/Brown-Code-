...
import { Terminal, ShieldAlert, Mail, Lock, Loader2, AlertCircle, LogIn } from "lucide-react";
    ...
    const executeLogin = async (e) => {
        ...
        try {
            ...
            if (userDocSnap.exists()) {
                // Log the successful login trace directly into the cloud database
            ...
            // Clean up low-level error codes into system readout strings
