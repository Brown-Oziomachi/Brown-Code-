export const articlesMeta = {
    ...
    "how-laundered-money-betting-crypto-gets-traced-nigeria": {
        category: "security",
        metaTitle: "How Stolen Money Through Betting Accounts and Crypto Wallets Gets Traced | Brown Code",
        metaDescription: "Sir Brown AD breaks down how Nigerian regulators actually trace stolen money moved through betting accounts and crypto wallets, and what fraud victims should do to recover it.",
        keywords: [
            "is crypto traceable Nigeria",
            "can EFCC trace crypto wallet",
            "betting account money laundering Nigeria",
            "how to trace stolen money Nigeria",
            "EFCC blockchain analysis",
            "report fraud EFCC Nigeria",
            "is stolen money untraceable myth",
            "how does money laundering work Nigeria",
            "SEC crypto regulation Nigeria 2025",
            "NFIU report fraud Nigeria",
            "how to recover money from fraudster Nigeria",
            "crypto wallet KYC Nigeria",
            "Designated Non-Financial Institution betting",
            "blockchain analysis EFCC crypto trace",
            "BVN fraud investigation Nigeria",
            "fraud recovery scam warning Nigeria",
            "Sir Brown AD",
        ],
    },
    "palmpay-fake-alert-app-how-to-verify-transfers-nigeria": {
        category: "security",
        metaTitle: "PalmPay Fake Alert App: How to Verify Every Transfer | Brown Code",
        metaDescription: "Sir Brown AD explains how the PalmPay fake alert app scam works, what Transaction Guard does and doesn't protect against, and how to verify a real transfer before releasing goods or services.",
        keywords: [
            "palmpay fake alert app",
            "palmpay fake transfer",
            "how to do palmpay fake alert",
            "palmpay fake alert",
            "fake palmpay transfer",
            "palmpay transaction guard",
            "how to verify palmpay transfer",
            "palmpay scam Nigeria",
            "fake alert app Nigeria",
            "palmpay fake payment alert",
            "is palmpay alert real",
            "palmpay fraud protection",
            "how to avoid fake alert scam",
            "palmpay account security",
            "Sir Brown AD",
        ],
    },
    ...
    // "kuda-fake-alert-fake-customer-care-scam-nigeria": {
    //     category: "security",
    //     metaTitle: "Kuda Fake Alert & Fake Customer Care Scams Explained | Brown Code",
    //     metaDescription: "Sir Brown AD explains how Kuda fake alert scams and fake customer-care impersonation accounts work, and how to verify what's real.",
    //     keywords: ["kuda fake alert", "kuda fake transfer", "kuda scam Nigeria", "kuda fake customer care", "kuda impersonation scam", "is kuda alert real", "kuda phishing scam", "how to verify kuda transfer", "fake alert app Nigeria", "Sir Brown AD"],
    // },
    // "sim-swap-fraud-nigeria-how-it-works": {
    //     category: "security",
    //     metaTitle: "SIM Swap Fraud in Nigeria: How It Works | Brown Code",
    //     metaDescription: "Sir Brown AD explains how SIM-swap fraud works in Nigeria, the warning signs to watch for, and how to protect your accounts.",
    //     keywords: ["sim swap fraud Nigeria", "what is sim swap scam", "how to prevent sim swap", "sim swap OTP fraud", "phone number stolen fraud", "NIBSS fraud report Nigeria", "sim swap warning signs", "protect bank account sim swap", "Sir Brown AD"],
    // },
    "moniepoint-fake-alert-fake-support-scam-nigeria": {
        category: "security",
        metaTitle: "Moniepoint Fake Alert & Fake Support Scams Explained | Brown Code",
        metaDescription: "Sir Brown AD explains how Moniepoint fake alert apps and fake support/loan pages work, and how to verify a transaction or contact before you act on it.",
        keywords: [
            "moniepoint fake alert",
            "moniepoint fake transfer",
            "moniepoint fake alert app",
            "moniepoint scam Nigeria",
            "moniepoint fake support page",
            "moniepoint fake loan offer",
            "moniepoint OTP scam",
            "is moniepoint alert real",
            "moniepoint phishing scam",
            "how to verify moniepoint transfer",
            "moniepoint account security",
            "moniepoint fake promo scam",
            "fake alert app Nigeria",
            "Sir Brown AD",
        ],
    },
